...
KS_threshold <- thresholds_params$model_testing$KS$Threshold
...
##Train
if (output_train >= KS_threshold) {
  train_conclusion = paste0("For training sample, the KS value is ", output_train, ", which is higher than the threshold of ",KS_threshold, 
                           ", indicating that discriminatory power of the model is good.")
} else{
  train_conclusion = paste0("For training sample, the KS value is ", output_train, ", which is lower than the threshold of ",KS_threshold, 
                            ", indicating that discriminatory power of the model is not sufficient.")
}

##Test
if (output_test >= KS_threshold) {
  test_conclusion = paste0("For testing sample, the KS value is ", output_test, ", which is higher than the threshold of ",KS_threshold, 
                            ", indicating that discriminatory power of the model is good.")
} else{
  test_conclusion = paste0("For testing sample, the KS value is ", output_test, ", which is lower than the threshold of ",KS_threshold, 
                            ", indicating that discriminatory power of the model is not sufficient.")
}
